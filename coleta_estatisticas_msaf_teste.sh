...
export ORACLE_HOME=/u04/app/oracle/product/12.1.0/dbhome_1
export PATH=.:/u04/app/oracle/product/12.1.0/dbhome_1/bin:/u04/app/oracle/product/12.1.0/dbhome_1/OPatch:/usr/bin:/bin:/etc:/usr/sbin:/usr/ucb:/u04/bin:/usr/bin/X11:/sbin:.:/usr/local/bin:/usr/java/bin/
...
spool /u01/home/atg/coleta_estatisticas_msaf.log
...
#LOG_FILE=/u04/atg/coleta_estatisticas_msaf.log
